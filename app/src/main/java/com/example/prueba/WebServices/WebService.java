package com.example.listview_is_2024.WebService;
...
import com.example.prueba.consulta_chofer;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    public WebService(String url, Map<String, String> datos, consulta_chofer activity, consulta_chofer consultaChofer) {
    }
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            com.example.listview_is_2024.WebService.HttpRequest h=new com.example.listview_is_2024.WebService.HttpRequest(this.url,params[0]);
        ...
        } catch (com.example.listview_is_2024.WebService.HttpRequest.HttpRequestException exception) {
